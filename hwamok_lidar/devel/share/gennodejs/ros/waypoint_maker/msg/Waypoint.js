...
class Waypoint {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('x_arr')) {
        ...
        this.x_arr = new Array(100).fill(0);
      }
      if (initObj.hasOwnProperty('y_arr')) {
        this.y_arr = initObj.y_arr
      }
      else {
        this.y_arr = new Array(100).fill(0);
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.x_arr.length !== 100) {
      throw new Error('Unable to serialize array field x_arr - length must be 100')
    }
    // Serialize message field [x_arr]
    bufferOffset = _arraySerializer.float64(obj.x_arr, buffer, bufferOffset, 100);
    // Check that the constant length array field [y_arr] has the right length
    if (obj.y_arr.length !== 100) {
      throw new Error('Unable to serialize array field y_arr - length must be 100')
    }
    // Serialize message field [y_arr]
    bufferOffset = _arraySerializer.float64(obj.y_arr, buffer, bufferOffset, 100);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.x_arr = _arrayDeserializer.float64(buffer, bufferOffset, 100)
    // Deserialize message field [y_arr]
    data.y_arr = _arrayDeserializer.float64(buffer, bufferOffset, 100)
    return data;
  }
  ...
  static md5sum() {
    ...
    return '2209f97173e73ff10670de6f39d0c518';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.x_arr !== undefined) {
      ...
      resolved.x_arr = new Array(100).fill(0)
    }
    ...
    if (msg.y_arr !== undefined) {
      ...
      resolved.y_arr = new Array(100).fill(0)
    }
