...
(cl:defmethod cl:initialize-instance :after ((m <DriveValues>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveValues)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_object_detector-msg:<DriveValues> is deprecated: use lidar_object_detector-msg:DriveValues instead.")))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <DriveValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_object_detector-msg:throttle-val is deprecated.  Use lidar_object_detector-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <DriveValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_object_detector-msg:steering-val is deprecated.  Use lidar_object_detector-msg:steering instead.")
  (steering m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveValues>)))
  ...
  "lidar_object_detector/DriveValues")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveValues)))
  "Returns string type for a message object of type 'DriveValues"
  "lidar_object_detector/DriveValues")
